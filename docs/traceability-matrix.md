...
| **6** | **5.15 Toegangsbeveiliging (autorisatie)** | RBAC; least privilege op admin-functies | D-4, E-1 / SR-17, SR-14 | `@Authorized`/`requirePrivilege` op `/cleardbcache`; autorisatie op `/user` afgedwongen door Core | `ClearDbCacheController2_0.java` | Pentest PT-14 + live hertest 17-06 (D-4 geweigerd, HTTP 500), PT-11 (E-1 niet exploiteerbaar) | `remediatie-status.md`, `pentest-hertest-17-06.md`, `attack-surface.md` sectie 5 | Geimplementeerd / geaccepteerd (E-1) |
...
| `pentest-hertest-17-06.md` | Live hertest 17-06 (voor/na de fixes) |
