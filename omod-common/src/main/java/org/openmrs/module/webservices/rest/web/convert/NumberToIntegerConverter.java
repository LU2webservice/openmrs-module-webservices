...
/**
 * Converts any {@link Number} source to an {@link Integer} target.
 */
public class NumberToIntegerConverter implements TypeConverter {

	@Override
	public boolean canConvert(Object source, Class<?> toClass, Type toType) {
		return toClass.isAssignableFrom(Integer.class) && source instanceof Number;
	}
