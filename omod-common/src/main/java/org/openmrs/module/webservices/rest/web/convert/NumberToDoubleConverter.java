...
/**
 * Converts any {@link Number} source to a {@link Double} target.
 */
public class NumberToDoubleConverter implements TypeConverter {

	@Override
	public boolean canConvert(Object source, Class<?> toClass, Type toType) {
		return toClass.isAssignableFrom(Double.class) && source instanceof Number;
	}
